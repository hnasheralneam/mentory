          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <DropdownMenu>
                ...
                <DropdownMenuContent className="dark:bg-[#181818] dark:border-[#444] dark:text-white">
                  <DropdownMenuItem className="dark:hover:bg-[#2a2a2a] dark:hover:text-gray-50">
                    Book a Session
                  </DropdownMenuItem>
                  <DropdownMenuItem className="dark:hover:bg-[#2a2a2a] dark:hover:text-gray-50">
                    View Schedule
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/signup">
                <Button
                  size="lg"
                  className="bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-400 text-white dark:text-black px-8 py-3 rounded-full"
                >
                  Get Started
                </Button>
              </Link>
